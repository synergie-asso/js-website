...
skel.init({
	reset: 'full',
	breakpoints: {
		global:		{ range: '*', href: 'testnumero1/theme/css/style.css', containers: 1400, grid: { gutters: 50 } },
		wide:		{ range: '-1680', href: '/testnumero2/theme/css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
